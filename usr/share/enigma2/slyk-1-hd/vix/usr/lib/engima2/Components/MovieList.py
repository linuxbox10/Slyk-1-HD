...
class MovieList(GUIComponent):
	...
	def setFontsize(self):
		...
		self.l.setFont(3, gFont(self.fontName, 27))
	...
	def buildMovieListEntry(self, serviceref, info, begin, data):
			...
			if info is None:
				...
				if txt == ".Trash":
					if ext == "0":
						...
						res.append(MultiContentEntryText(pos=(8, 0), size=(382, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=_("Deleted items")))
						res.append(MultiContentEntryPixmapAlphaBlend(pos=(419, iconPosY), size=(iconSize, iconSize), png=self.iconTrash))
						res.append(MultiContentEntryText(pos=(470, 0), size=(218, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=_("Trashcan")))
						return res
			if ext == "0":
				...
				res.append(MultiContentEntryText(pos=(8, 0), size=(382, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=txt))
				res.append(MultiContentEntryPixmapAlphaBlend(pos=(419, iconPosY), size=(iconSize, 28), png=self.iconSeries))
				res.append(MultiContentEntryText(pos=(470, 0), size=(218, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=_("Directory")))
				return res
		...
		if ext == '1':
			...
			if fileExtension in RECORD_EXTENSIONS:
				if data.part is not None and data.part > 0:
					res.append(MultiContentEntryProgress(pos=(606, 15), size=(82, 6), percent=data.part, borderWidth=1, foreColor=0x207be1, foreColorSelected=0x207be1, backColor=0x0b1e40, backColorSelected=None))
				res.append(MultiContentEntryText(pos=(8, 0), size=(382, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=data.txt))
				res.append(MultiContentEntryPixmapAlphaBlend(pos=(419, iconPosY), size=(iconSize, iconSize), png=data.icon))
				res.append(MultiContentEntryText(pos=(470, 0), size=(135, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=data.viewed))
				res.append(MultiContentEntryText(pos=(712, 0), size=(206, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=service))
				res.append(MultiContentEntryText(pos=(942, 0), size=(126, 36), font=1, flags=RT_HALIGN_RIGHT | RT_VALIGN_CENTER, text=slyk_date_string))
				return res
			else:
				if data.part is not None and data.part > 0:
					res.append(MultiContentEntryProgress(pos=(606, 15), size=(82, 6), percent=data.part, borderWidth=1, foreColor=0x207be1, foreColorSelected=0x207be1, backColor=0x0b1e40, backColorSelected=None))
					...
					res.append(MultiContentEntryText(pos=(470, 0), size=(218, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=data.viewed))
				res.append(MultiContentEntryText(pos=(8, 0), size=(382, 36), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=data.txt))
				res.append(MultiContentEntryPixmapAlphaBlend(pos=(419, iconPosY), size=(iconSize, iconSize), png=self.iconDownloaded))
				res.append(MultiContentEntryText(pos=(942, 0), size=(126, 36), font=1, flags=RT_HALIGN_RIGHT | RT_VALIGN_CENTER, text=slyk_date_string))
				return res
		else:
